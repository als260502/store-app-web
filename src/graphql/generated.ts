...
export type ScheduledOperationAffectedDocument = Asset | AuthUser | Category | Collection | Company | Currency | Order | OrderItem | Product | ProductColorVariant | ProductSizeVariant | Review | StoreUser;
...
export type GetOrdersPaginationQueryVariables = Exact<{
  first?: InputMaybe<Scalars['Int']>;
  skip?: InputMaybe<Scalars['Int']>;
}>;


export type GetOrdersPaginationQuery = { ordersConnection: { edges: Array<{ node: { createdAt: any, id: string, parcel?: number | null, orderValue: number, paymentType?: string | null, total: number, userEmail?: string | null, storeUser?: { name: string, surname: string, nickname?: string | null, phones: Array<string>, description?: string | null } | null } }>, pageInfo: { hasNextPage: boolean, hasPreviousPage: boolean, pageSize?: number | null } } };

export type GetOrdersQueryVariables = Exact<{ [key: string]: never; }>;


export type GetOrdersQuery = { orders: Array<{ createdAt: any, id: string, parcel?: number | null, orderValue: number, paymentType?: string | null, total: number, userEmail?: string | null, storeUser?: { name: string, surname: string, nickname?: string | null, phones: Array<string>, description?: string | null } | null }> };
...
export type GetProductsQuery = { products: Array<{ id: string, name: string, description: string, price: number, quantity: number, slug: string, size: Array<{ name: string }>, color: Array<{ name: string }>, categories: Array<{ name: string }> }> };
...
export type GetStoreUsersQuery = { storeUsers: Array<{ name: string, nickname?: string | null, surname: string, phones: Array<string>, email: string, id: string, orders: Array<{ id: string }> }> };
...
export const GetOrdersPaginationDocument = gql`
    query GetOrdersPagination($first: Int, $skip: Int) {
  ordersConnection(first: $first, skip: $skip) {
    edges {
      node {
        createdAt
        id
...
/**
 * __useGetOrdersPaginationQuery__
 *
 * To run a query within a React component, call `useGetOrdersPaginationQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetOrdersPaginationQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetOrdersPaginationQuery({
 *   variables: {
 ...
 * });
 */
export function useGetOrdersPaginationQuery(baseOptions?: Apollo.QueryHookOptions<GetOrdersPaginationQuery, GetOrdersPaginationQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetOrdersPaginationQuery, GetOrdersPaginationQueryVariables>(GetOrdersPaginationDocument, options);
      }
export function useGetOrdersPaginationLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetOrdersPaginationQuery, GetOrdersPaginationQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetOrdersPaginationQuery, GetOrdersPaginationQueryVariables>(GetOrdersPaginationDocument, options);
        }
export type GetOrdersPaginationQueryHookResult = ReturnType<typeof useGetOrdersPaginationQuery>;
export type GetOrdersPaginationLazyQueryHookResult = ReturnType<typeof useGetOrdersPaginationLazyQuery>;
export type GetOrdersPaginationQueryResult = Apollo.QueryResult<GetOrdersPaginationQuery, GetOrdersPaginationQueryVariables>;
